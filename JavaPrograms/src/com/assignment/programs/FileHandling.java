...
public class FileHandling {
	...
	public static void AddRecord() throws IOException {
		BufferedWriter bw = new BufferedWriter(new FileWriter("D:\\Chetana\\Files\\records.txt", true));
		Scanner strInput = new Scanner(System.in);
	...
	public static void ViewAllRecord() throws IOException {
		BufferedReader br = new BufferedReader(new FileReader("D:\\Chetana\\Files\\records.txt"));
		String record;
		System.out.println(" ------------------------------------------------------------- ");
	...
	public static void DeleteRecordByID() throws IOException {
		...
		File db = new File("D:\\Chetana\\Files\\records.txt");
